...
export const columns = [
  ...
  {
    title: '名称', width: 220, dataIndex: 'name', key: 'name',
  ...
  {
    title: '危险等级', width: 160, dataIndex: 'risk_level', key: 'risk_level',
  ...
  {
    title: 'Baseline', width: 100, dataIndex: 'baseline', key: 'baseline',
